...
import { Stethoscope, Smile, Shield, Star, CheckCircle } from "lucide-react";
    ...
    <>
      ...
      <main>
        <section
          ...
          style={{
            background:
              "linear-gradient(135deg, var(--primary-light) 0%, var(--background) 50%, var(--accent-light) 100%)",
          }}
        >
          <div className="max-w-6xl mx-auto px-4 py-20 relative w-full">
            <div className="max-w-2xl">
              ...
              >
                Pružamo savremenu stomatološku negu sa toplinom i pažnjom. Vaše
                zdravlje i osmeh su naš prioritet.
              </p>
